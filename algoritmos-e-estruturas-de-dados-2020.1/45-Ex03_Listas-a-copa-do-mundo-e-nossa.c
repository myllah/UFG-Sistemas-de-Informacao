...
void criarFilaVazia(Fila *F){
	...
	F->inicio = A; // faço o inicio da fila apontar para a caixa A
...
void enfileirar(Fila *F, Pessoa pessoa){
	...
	F->fim->prox = A; // faço o ponteiro prox do ultimo da fila apontar para a caixa A - fazendo q o ultimo da fila não seja mais o ultimo
	F->fim = A; // faço o fim da fila apontar para a caixa A
