...
quando representa a mesma quantidade lido da esquerda para a direita e da direita para a esquerda.
...
Caso o número seja válido o programa deve imprimir a mensagem "PALINDROMO", caso o
